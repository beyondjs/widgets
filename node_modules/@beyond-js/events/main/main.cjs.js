...
exports.hmr = exports.__beyond_pkg = exports.ListenerFunction = exports.Events = void 0;
...
__pkg.exports.process = function ({
  ...
  (require || prop === 'Events') && (exports.Events = Events = require ? require('./events').Events : value);
  (require || prop === 'ListenerFunction') && (exports.ListenerFunction = ListenerFunction = require ? require('./types').ListenerFunction : value);
};
