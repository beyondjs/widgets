define(["exports", "module", "@beyond-js/kernel/bundle"], function (_exports, _amd_module, dependency_0) {
  ...
  _exports.hmr = _exports.__beyond_pkg = _exports.ListenerFunction = _exports.Events = void 0;
  const {
    Bundle: __Bundle
  } = dependency_0;
  const __pkg = new __Bundle({
    "module": {
      "vspecifier": "@beyond-js/events@0.0.5/main"
    },
    "type": "ts"
  ...
  ***********************/
  ...
  __pkg.exports.process = function ({
    ...
    (require || prop === 'Events') && (_exports.Events = Events = require ? require('./events').Events : value);
    (require || prop === 'ListenerFunction') && (_exports.ListenerFunction = ListenerFunction = require ? require('./types').ListenerFunction : value);
  };
