...
| [application](../src/modules/application/module.json) | web | `application`, whose `start({ layout?, routing?, container? })` configures the routing of the runtime, starts the routing manager and appends the main layout element. |
